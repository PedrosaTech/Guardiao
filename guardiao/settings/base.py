...
# Se houver DATABASE_URL, usar dj-database-url com PostgreSQL
if os.getenv('DATABASE_URL'):
    ...
    # Caso contrário, usar SQLite para dev
    DATABASES['default'] = {
...
# Chave para criptografar dados sensíveis (CPF, CNPJ, telefone, etc.)
